...
\subsection{Tại sao luyện kim bột quan trọng}
...
\subsection{Hạn chế và nhược điểm}
...
\subsection{Vật liệu gia công PM}
...
\subsection{Các nhận xét về ma sát giữa các hạt}
...
\subsection{Hệ số nén = Mật độ đống chia cho Mật độ thực}
