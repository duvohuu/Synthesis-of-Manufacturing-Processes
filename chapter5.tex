...
\hspace*{0.6cm}Gia công mài (Grinding) và các quá trình gia công bằng hạt mài khác là nhóm phương pháp gia công cắt gọt trong đó vật liệu được bóc đi nhờ các hạt mài có độ cứng rất cao. Các quá trình này thường được sử dụng ở công đoạn gia công tinh nhằm đạt độ chính xác kích thước cao và chất lượng bề mặt tốt.

\section{Gia công bằng hạt mài}
\hspace*{0.6cm}Gia công bằng hạt mài là quá trình bóc vật liệu thông qua sự tiếp xúc giữa chi tiết gia công và các hạt mài cứng, được liên kết trong bánh mài hoặc tồn tại tự do.
...
\subsection{Độ cứng bánh mài (Wheel Grade)}
\begin{itemize}
...
\subsection{Mài sắc bánh mài (Dressing)}
...
\subsection{Sửa dạng bánh mài (Truing)}
...
\begin{table}[H]
\centering
\caption{Các loại hạt mài chính}
...
\end{tabular}
\end{table}
\subsection{Kích thước hạt mài và chất kết dính}

\subsubsection{Kích thước hạt mài}
\begin{itemize}
...
\subsection{Cơ chế tác dụng của hạt mài}
...
\subsection{Các tác hại của nhiệt:}
\begin{itemize}
...
\subsection{Biện pháp giảm nhiệt khi mài}
\begin{itemize}
    \item Giảm chiều sâu cắt $d$ (Decrease infeed - depth of cut).
...
\subsection{Bốn loại mài bề mặt phẳng (Surface Grinding)}
\begin{enumerate}
