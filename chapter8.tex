\chapter{CÁC NGUYÊN CÔNG GIA CÔNG CẮT GỌT VÀ MÁY CÔNG CỤ}
     \section{Tiện và các nguyên công liên quan - Turning}
          \subsection{Quá trình tiện}
               \hspace*{0.6cm}\textbf{Nguyên lý cơ bản:} Sử dụng dụng cụ cắt đơn điểm (single point cutting tool) để loại bỏ vật liệu từ một \textbf{phôi đang quay} nhằm tạo ra hình trụ. Quá trình tiện được thực hiện trên máy tiện (lathe). Các nguyên công của quá trình tiện:
               \begin{itemize}
     ...
     \section{Phay - Milling}
          \subsection{Định nghĩa}
               \hspace*{0.6cm}Nguyên công phay là nguyên công gia công cắt gọt, trong đó phôi chuyển động qua một dụng cụ \textbf{cắt quay}, dụng cụ có nhiều lưỡi cắt.
               \begin{itemize}
