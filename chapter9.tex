\chapter{CÁC CÂU HỎI ÔN TẬP}
    ...
    \section{Cấu tạo và chức năng các bộ phận của khuôn đúc}
        ...
        \end{itemize}
    \section{Cấu tạo dụng cụ cắt}
        \subsection{Phân loại dụng cụ cắt}

        \begin{itemize}
            \item \textbf{Dụng cụ cắt một lưỡi (Single-point cutting tools):}  
            Dao tiện, dao bào, dao xọc; thường dùng trong gia công tiện và bào.

            \item \textbf{Dụng cụ cắt nhiều lưỡi (Multi-point cutting tools):}  
            Dao phay, mũi khoan, dao doa, dao chuốt; cho năng suất cao hơn.
        \end{itemize}

        %------------------------------------------------

        \subsection{Cấu tạo hình học của dụng cụ cắt}

        Hình học dụng cụ cắt quyết định cơ chế tạo phoi,
        lực cắt, nhiệt cắt và chất lượng bề mặt gia công.

        \begin{itemize}
            \item \textbf{Mặt trước (Rake face):}  
            Bề mặt mà phoi trượt lên trong quá trình cắt.

            \item \textbf{Mặt sau (Flank face):}  
            Bề mặt đối diện với bề mặt gia công,
            có tác dụng tránh ma sát giữa dao và chi tiết.

            \item \textbf{Lưỡi cắt chính (Major cutting edge):}  
            Phần giao tuyến giữa mặt trước và mặt sau,
            trực tiếp tham gia cắt gọt vật liệu.

            \item \textbf{Lưỡi cắt phụ (Minor cutting edge):}  
            Ảnh hưởng đến hình dạng biên dạng và độ nhẵn bề mặt.

            \item \textbf{Mũi dao (Tool nose):}  
            Vùng nối giữa lưỡi cắt chính và lưỡi cắt phụ,
            ảnh hưởng mạnh đến độ bền dao và chất lượng bề mặt.
        \end{itemize}

        %------------------------------------------------

        \subsection{Các góc hình học của dụng cụ cắt}

        \begin{itemize}
            \item \textbf{Góc trước ($\gamma$ – Rake angle):}  
            Ảnh hưởng đến khả năng tạo phoi, lực cắt và nhiệt sinh ra khi gia công.

            \item \textbf{Góc sau ($\alpha$ – Clearance angle):}  
            Giảm ma sát giữa dao và bề mặt gia công.

            \item \textbf{Góc sắc ($\beta$ – Wedge angle):}  
            Quyết định độ bền cơ học của lưỡi cắt;
            góc sắc lớn làm dao bền hơn nhưng lực cắt tăng.
        \end{itemize}

        %------------------------------------------------

        \subsection{Cấu tạo kết cấu dụng cụ cắt}

        Dựa theo kết cấu chế tạo và lắp ráp,
        dụng cụ cắt được chia thành các dạng sau:

        \begin{itemize}
            \item \textbf{Dao liền (Solid cutting tool):}  
            Dụng cụ được chế tạo nguyên khối từ một loại vật liệu;
            kết cấu đơn giản nhưng khó thay thế khi mòn.

            \item \textbf{Dao hàn mảnh (Brazed tool):}  
            Mảnh cắt được hàn cố định lên thân dao;
            cải thiện khả năng cắt nhưng vẫn khó tái sử dụng.

            \item \textbf{Dao gắn mảnh (Indexable insert tool):}  
            Mảnh cắt rời được kẹp cơ khí vào thân dao,
            có thể thay thế hoặc xoay khi mòn,
            được sử dụng phổ biến trong gia công hiện đại.
        \end{itemize}

        %------------------------------------------------

        \subsection{Mảnh cắt và lớp phủ dụng cụ}

        \begin{itemize}
            \item \textbf{Mảnh cắt (Insert):}  
            Là bộ phận trực tiếp cắt vật liệu,
            thường chế tạo từ cacbit, gốm, CBN hoặc kim cương.

            \item \textbf{Lớp phủ (Coating):}  
            Phủ lên bề mặt mảnh cắt nhằm:
            \begin{itemize}
                \item Giảm ma sát giữa dao và phoi.
                \item Tăng độ cứng nóng.
                \item Kéo dài tuổi thọ dụng cụ.
            \end{itemize}
        \end{itemize}

        %------------------------------------------------

        \subsection{Thân dao và cơ cấu kẹp}

        \begin{itemize}
            \item \textbf{Thân dao (Tool holder):}  
            Giữ và định vị mảnh cắt,
            truyền lực cắt từ dao sang máy công cụ.

            \item \textbf{Cơ cấu kẹp mảnh:}  
            Đảm bảo mảnh cắt cố định,
            ổn định trong quá trình gia công ở tốc độ và lực lớn.
        \end{itemize}
